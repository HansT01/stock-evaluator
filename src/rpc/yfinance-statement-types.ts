export type IncomeStatementSuffix =
...
type BalanceSheetStatementSuffix =
...
export type IncomeStatementType = `${'annual' | 'quarterly'}${IncomeStatementSuffix}`
export type BalanceSheetStatementType = `${'annual' | 'quarterly'}${BalanceSheetStatementSuffix}`
export type CashFlowStatementType = `${'annual' | 'quarterly'}${CashFlowStatementSuffix}`
